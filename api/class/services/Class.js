...
module.exports = {
  ...
  fetchAll: (params, populate) => {
    ...
    const populateOpt = populate || Class.associations
  ...
  edit: async (params, values) => {
    ...
    const entry = await Class.updateOne(params, data, { multi: true });
  ...
  search: async (params) => {
    ...
    const $or = Object.keys(Class.attributes).reduce((acc, curr) => {
      switch (Class.attributes[curr].type) {
        case 'integer':
        case 'float':
        case 'decimal':
